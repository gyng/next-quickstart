// https://medium.com/@joranquinten/generate-a-sitemap-for-your-static-nextjs-website-hosted-on-netlify-4288d5a859a1
...
const getPriority = url => {
  ...
  return ((100 - (url.split("/").length - 2) * 10) / 100).toFixed(2);
};
